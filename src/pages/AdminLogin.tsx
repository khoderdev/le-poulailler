        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#9c2622] focus:border-transparent outline-none transition-all"
          ...
          <button
            type="submit"
            className="w-full bg-[#9c2622] text-white py-3 rounded-lg font-semibold hover:bg-[#7a1e1b] transition-colors"
          >
            Login
          </button>
        </form>
